      ...
      <div className={styles.main_container}>
        ...
        <div className={styles.card}>
            ...
            position: 'relative',
                ...
                <Image src="/assets/blackout.jpg" alt="Test" fill quality={85} style={{objectFit: 'cover', objectPosition: 'center'}}></Image>
            </div>
        ...
        <div className={`${styles.card} ${styles.card3}`}>
            <Image src="/assets/pretty.jpg" alt="Test" fill quality={85} style={{objectFit: 'cover', objectPosition: 'center'}}></Image>
        </div>
        <div className={`${styles.card} ${styles.card4}`}>
        <div style={{
            position: 'relative',
            }}>
                <Image src="/assets/teach.jpg" alt="Test" fill quality={85} style={{objectFit: 'cover', objectPosition: 'center'}}></Image>
            </div>
