    ...
    return (
        <div className={`${styles.heroContainer}`}>
            ...
            <div className={styles.mainDiv}>
                ...
                <Link href="/about"><button className="bg-[#ffc93c] text-[16px] font-bold text-black rounded-[4px] block m-auto px-[50px] py-4 mt-5 relative z-20">LEARN MORE ABOUT US</button></Link>
            </div>
        </div>
    );
};
