    ...
    return (
        <div className={`${styles.heroContainer}`}>
            ...
            <div className={styles.main}>
                ...
                <p className={`bg-[white] p-3`}>Harnessing the power of the sun to light up lives. At Luminous Life Foundation, we are dedicated to driving sustainable solar solutions, bringing reliable electricity to communities, and fostering a brighter, self-sufficient future.</p>
